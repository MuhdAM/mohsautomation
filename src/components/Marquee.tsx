...
const Marquee = () => (
  <div className="overflow-hidden border-y border-black/5 dark:border-white/5 py-4 bg-[#F4F1EA] dark:bg-[#09151A] transition-colors duration-300" aria-hidden="true">
