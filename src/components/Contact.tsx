...
const Contact = () => (
  <section id="contact" className="relative bg-[#101013] border-t border-white/5" aria-labelledby="contact-heading">
    <div className="max-w-[1200px] mx-auto px-[5vw] py-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <h2 id="contact-heading" className="font-display text-[clamp(2rem,4vw,3.5rem)] font-bold tracking-tight leading-[1.1] mt-4 mb-4 text-white">
            Ready to Automate?
          </h2>
          ...
          <div className="mt-10 bg-[#151518] border border-white/5 rounded-2xl p-8">
            <h4 className="font-display font-bold text-base mb-4 text-white">Availability</h4>
        ...
        >
          <a href="https://wa.me/2349155733195" target="_blank" rel="noopener noreferrer" className="bg-[#151518] border border-white/5 hover:border-primary/50 rounded-2xl p-6 flex gap-5 items-start group transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            ...
            <div>
              ...
              <div className="font-display font-bold text-xl mt-1 text-white">09155733195</div>
              <span className="text-sm text-muted-foreground mt-1 block">Tap to message on WhatsApp</span>
            </div>
          </a>

          <a href="mailto:mohsautomation@gmail.com" className="bg-[#151518] border border-white/5 hover:border-primary/50 rounded-2xl p-6 flex gap-5 items-start group transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
            <div className="w-14 h-14 rounded-xl flex items-center justify-center flex-shrink-0 bg-primary/10 group-hover:scale-110 transition-transform duration-300">
            ...
            <div>
              ...
              <div className="font-display font-bold text-xl mt-1 text-white">mohsautomation@gmail.com</div>
              <span className="text-sm text-muted-foreground mt-1 block">For project enquiries & quotes</span>
            </div>
          </a>

          <div className="bg-[#151518] border border-white/5 rounded-2xl p-6 flex gap-5 items-start">
            ...
            <div>
              ...
              <div className="font-display font-bold text-xl mt-1 text-white">Abuja, Nigeria</div>
