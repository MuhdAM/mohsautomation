...
const WhyUs = () => (
  <section id="why-us" className="relative bg-[#FDFBF7] dark:bg-[#060E12] border-t border-black/5 dark:border-white/5 transition-colors duration-300" aria-labelledby="whyus-heading">
