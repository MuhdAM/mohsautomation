...
const TrustedByAdmin = () => {
  ...
  const handleAdd = async () => {
    ...
    toast.promise(supabase.from("trusted_by").insert({ name }), {
      loading: "Adding...",
  ...
  const handleDelete = async (id: string) => {
    ...
    toast.promise(supabase.from("trusted_by").delete().eq("id", id), {
      loading: "Deleting...",
...
const TestimonialsAdmin = () => {
  ...
  const handleAdd = async () => {
    ...
    toast.promise(supabase.from("testimonials").insert({ name, role, org, quote }), {
      loading: "Adding...",
  ...
  const handleDelete = async (id: string) => {
    ...
    toast.promise(supabase.from("testimonials").delete().eq("id", id), {
      loading: "Deleting...",
...
const ResultsAdmin = () => {
  ...
  const handleDelete = async (id: string) => {
    if (!window.confirm("Are you sure?")) return;
    toast.promise(supabase.from("results").delete().eq("id", id), {
      loading: "Deleting...",
...
const DemosAdmin = () => {
  ...
  const handleDelete = async (id: string) => {
    if (!window.confirm("Are you sure?")) return;
    toast.promise(supabase.from("demos").delete().eq("id", id), {
      loading: "Deleting...",
